...
namespace UnityMCP.Editor.Commands
{
    ...
    public static class CommandRegistry
    {
        private static readonly Dictionary<string, Func<JObject, object>> _handlers = new()
        {
            ...
            { "CREATE_ADVANCED_MATERIAL", parameters => MaterialCommandHandler.CreateAdvancedMaterial(parameters) },
            { "SET_MATERIAL_PROPERTIES", parameters => MaterialCommandHandler.SetMaterialProperties(parameters) },
            { "SET_MATERIAL_TEXTURE", parameters => MaterialCommandHandler.SetMaterialTexture(parameters) },
            { "CREATE_MATERIAL_FROM_TEMPLATE", parameters => MaterialCommandHandler.CreateMaterialFromTemplate(parameters) },
