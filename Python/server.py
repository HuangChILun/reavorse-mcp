...
def asset_creation_strategy() -> str:
    ...
    return (
        ...
        "   - `set_material(object_name, material_name, color)` - Apply/create basic materials\n"
        "   - `create_advanced_material(material_name, shader_type, render_mode)` - Create advanced materials with specific shaders\n"
        "   - `set_material_properties(material_path, color, metallic, smoothness, ...)` - Set physical properties of materials\n"
        "   - `set_material_texture(material_path, texture_type, texture_path)` - Apply textures to materials\n"
        "   - `create_material_from_template(material_name, template)` - Create materials using predefined templates\n"
